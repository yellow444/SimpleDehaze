...
namespace SimpleDeHaze.Methods
{
    ...
    public sealed class ClaheMethod : IDeHazeMethod
    {
        ...
        public string Description =>
            ...
            "Формула: в каждом тайле L' = CDF_clip(L)·L_max, где гистограмма обрезается по уровню clip\n" +
            "(излишек равномерно перераспределяется — анти-шум), между тайлами — билинейная интерполяция.\n\n" +
