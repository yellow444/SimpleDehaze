...
а не speed/SOTA claim. [Полный исследовательский отчёт](SimpleDeHaze/docs/research/hcv-a2cr-utaw-study-2026-08.md).
...
для смягчения краев у ярких мест изображения. Это могут быть источники света, места с сильным эффектом дымки, различные отражающие поверхности. Для GPU версии я использовал работу Kaiming He; исходная реализация Guided Filter была опубликована автором вместе со статьёй.
